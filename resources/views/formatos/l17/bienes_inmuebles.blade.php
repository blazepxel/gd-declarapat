...
<div class="form-group{{ $errors->has('ninguno') ? ' has-error' : '' }}">
  <label for="ninguno" class="col-md-4">Ningún Bien Inmueble:<code>*</code></label>
  <div class="col-md-8">
    <label>
      <input id="ninguno" type="checkbox" name="ninguno" value="1" tabindex="{{ ++$tabindex }}" @if($datos->ninguno == 1 or old('ninguno') == 1) checked  @endif>
      <code>Palomea en caso de que NO tengas bienes inmuebles que declarar.</code>
    </label>
  </div>
  <div class="col-md-4">
  </div>
...
<table id="tabla" class="table table-hover text-center">
  <caption>BIENES INMUEBLES</caption>
  <thead>
    <tr>
      <th scope="col">Estatus</th>
      <th scope="col">Tipo de bien</th>
      <th scope="col">Forma de operación</th>
          ...
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              <div class="modal-body">
                <p><strong>¿Realmente deseas borrar este bien inmueble?</strong></p>
              </div>
