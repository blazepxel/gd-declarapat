...
@section('campos')
            ...
            <div id="div_estado" class="form-group{{ $errors->has('estado') ? ' has-error' : '' }}">
              ...
              <div class="col-md-6">
                <select id="estado" tabindex="{{ ++$tabindex }}" class="form-control" required autofocus>
                  <option></option>
            ...
            <div id="div_municipio" class="form-group{{ $errors->has('municipio') ? ' has-error' : '' }}">
              ...
              <div class="col-md-6">
                <select id="municipio" tabindex="{{ ++$tabindex }}" class="form-control" required>
                  <option></option>
                </select>
            ...
            <div id="div_provincia" class="form-group{{ $errors->has('estado') ? ' has-error' : '' }}">
              ...
              <div class="col-md-6">
                <input id="provincia" type="text" class="form-control" tabindex="{{ ++$tabindex }}" value="@if(old('estado')){{ old('estado') }}@else{{ $datos->estado }}@endif" maxlength="35">
                @if ($errors->has('estado'))
                <span class="help-block">
                  <strong>{{ $errors->first('estado') }}</strong>
                </span>
            ...
            <div id="div_condado" class="form-group{{ $errors->has('municipio') ? ' has-error' : '' }}">
              <label for="condado" class="col-md-4 control-label">Municipio o condado: <code>*</code></label>
              <div class="col-md-6">
                <input id="condado" type="text" class="form-control" tabindex="{{ ++$tabindex }}" value="@if(old('municipio')){{ old('municipio') }}@else{{ $datos->municipio }}@endif" maxlength="35">
                @if ($errors->has('municipio'))
                <span class="help-block">
                  <strong>{{ $errors->first('municipio') }}</strong>
                </span>
            ...
            <div class="form-group{{ $errors->has('numero_exterior') ? ' has-error' : '' }}">
              ...
              <div class="col-md-3">
                <input id="numero_exterior" type="number" class="form-control" tabindex="{{ ++$tabindex }}" name="numero_exterior" value="@if(old('numero_exterior')){{ old('numero_exterior') }}@else{{ $datos->numero_exterior }}@endif" min="1" max="9999">
            ...
            <div class="form-group{{ $errors->has('numero_interior') ? ' has-error' : '' }}">
              ...
              <div class="col-md-3">
                <input id="numero_interior" type="number" class="form-control" name="numero_interior" tabindex="{{ ++$tabindex }}" value="@if(old('numero_interior')){{ old('numero_interior') }}@else{{ $datos->numero_interior }}@endif" min="1" max="999">
