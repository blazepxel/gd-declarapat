...
<div class="form-group{{ $errors->has('ninguno') ? ' has-error' : '' }}">
  <label for="ninguno" class="col-md-4">Ningún cargo o comision:<code>*</code></label>
  <div class="col-md-8">
    <label>
      <input id="ninguno" type="checkbox" name="ninguno" value="1" tabindex="{{ ++$tabindex }}" @if($datos->ninguno == 1 or old('ninguno') == 1) checked  @endif>
      <code>Palomea en caso de que NO tengas cargos o comisiones.</code>
    </label>
  </div>
  <div class="col-md-4">
  </div>
...
<table id="tabla" class="table table-hover text-center">
  <caption>PUESTO, ACTIVIDADES, ETC.</caption>
  <thead>
    <tr>
          ...
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              <div class="modal-body">
                <p><strong>¿Realmente deseas borrar este  puesto o comisión?</strong></p>
              </div>
