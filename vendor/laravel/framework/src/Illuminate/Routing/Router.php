...
class Router implements RegistrarContract
{
    ...
    public function auth()
    {
        ...
        $this->get('administrador', 'Auth\AuthController@showLoginForm');
        $this->post('login', 'Auth\AuthController@login');
        $this->get('salir', 'Auth\AuthController@logout');

        // Registration Routes...
        $this->get('registrarse', 'Auth\AuthController@showRegistrationForm');
        $this->post('registrarse', 'Auth\AuthController@register');
